...
import { Layout, Row, Col, Table, Input, message, Select } from 'antd';
import { SearchOutlined } from '@ant-design/icons';
import debounce from 'lodash/debounce';
import AdminLayout from '../../../../component/adminComponent/admin.layout.component';
import { fetchPatients, Patient } from '@/utils/patient';
...
const AdminPatientPage = () => {
  ...
  const columns = [
    ...
    { 
      ...
      key: "date_of_birth",
      render: (date_of_birth: string) => calculateAge(date_of_birth)
    },
    { 
      title: "Gender", 
      dataIndex: "gender", 
